...
<link rel="stylesheet" href="${ctx}/css/owl.carousel.css" type="text/css" media="all"/> <!-- Owl-Carousel-CSS -->
<!-- //Custom Theme files --> 
<!-- js -->
...
<body>
	...
	<div class="banner">
			...
			<div class="w3ls-header"><!-- header-one --> 
				<div class="container">
					...
					<div class="w3ls-header-right">
						<ul> 
							<li class="head-dpdn">
								<i class="fa fa-phone" aria-hidden="true"></i> 订餐热线: +01 222 33345 
							</li> 
							<li class="head-dpdn">
							...
							<li class="head-dpdn">
								<a href="resOffers.jsp"><i class="fa fa-gift" aria-hidden="true"></i> 提供</a>
							</li> 
							<li class="head-dpdn">
								<a href="resHelp.jsp"><i class="fa fa-question-circle" aria-hidden="true"></i> 帮助</a>
							</li>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav navbar-right">
								<li><a href="reIndex.jsp" class="active">主页</a></li>	
								<!-- Mega Menu -->
								<li class="dropdown">
										...
										<div class="row">
											<div class="col-sm-4">
												<ul class="multi-column-dropdown">
													<h6>食物类型</h6>  
													<li><a href="resProducts.jsp">早餐</a></li> 
													<li><a href="resMenu.jsp">午餐</a></li> 
													<li><a href="resMenu.jsp">晚餐</a></li> 
												</ul>
											</div>
											<div class="col-sm-4">
												<ul class="multi-column-dropdown">
													<h6>烹调</h6> 
													<li><a href="resMenu.jsp">湘菜</a></li> 
													<li><a href="resMenu.jsp">粤菜</a></li> 
													<li><a href="resMenu.jsp">鲁菜</a></li> 
													<li><a href="resMenu.jsp">西餐</a></li> 
												</ul>
											</div>
											<div class="col-sm-4">
												<ul class="multi-column-dropdown">
													<h6>分量</h6> 
													<li><a href="resMenu.jsp">饮料</a></li> 
													<li><a href="resMenu.jsp">迷你</a></li> 
													<li><a href="resMenu.jsp">常规</a></li> 
													<li><a href="resMenu.jsp">特色菜</a></li> 
												</ul>
											</div> 
											<div class="clearfix"></div>
										</div>
								...
								<li><a href="resAbout.jsp">关于</a></li> 
								...
								<li><a href="index.jsp">订房</a></li>
								<li><a href="resContact.jsp">联系我们</a></li>
							</ul>
						</div>
		...
		<div class="banner-text">	
			<div class="container">
				<h2>最好的食物<br> <span>给最好的你 </span></h2>
				<div class="agileits_search">
					<form action="#" method="post">
						<input style="width:590px" name="Search" type="text" placeholder="告诉我你想吃什么" required="">
		...
		<div class="container">
			<div class="add-products-row">
				<div class="w3ls-add-grids">
					<a href="menu.html"> 
						<h4>最高 <span>20%<br>超市夜未眠</span></h4>
						<h5>仅在移动应用程序中订购 </h5>
						<h6>现在预订 <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div>
				<div class="w3ls-add-grids w3ls-add-grids-right">
					<a href="menu.html"> 
						<h4>最高<span><br>40% 折扣</span></h4>
						<h5>周日特色菜</h5>
						<h6>现在预订<i class="fa fa-arrow-circle-right" aria-hidden="true"></i></h6>
					</a>
				</div> 
	...
	<div class="wthree-order">  
		...
		<div class="container">
			<h3 class="w3ls-title">如何在网上订购食物</h3>
			<p class="w3lsorder-text">3个简单的步骤就能得到你最喜欢的食物。</p>
