        ...
        <div class="row align-items-center">
            <div class="col-md-4">
                <div class="heading-wrap text-center element-animate">
                    <h4 class="sub-heading">住在我们的豪华房间里</h4>
                    ...
                    <p><a href="#" class="btn btn-primary btn-sm">更多关于我们</a></p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row mb-5">
            <div class="col-md-12 heading-wrap text-center">
                <h4 class="sub-heading">我们的豪华房间</h4>
        ...
        <div class="row ">
            <div class="col-md-7">
                <div class="media d-block room mb-0">
                    <figure>
                        <img src="images/r09.jpg" alt="Generic placeholder image" class="img-fluid">
                  ...
                  <span>
                    ...
                    <div class="media-body">
                        <ul class="room-specs">
                            <li><span class="ion-ios-people-outline"></span> 2 人</li>
                            <li><span class="ion-ios-crop"></span> 100 m <sup>2</sup></li>
                        </ul>
                        <p>Nulla vel metus scelerisque ante sollicitudin. Fusce condimentum nunc ac nisi vulputate fringilla. </p>
                        <p><a href="sys/room/toBookNow?id=0f883fcf-0c08-11e9-b962-54e1ad667784" class="btn btn-primary btn-sm">现在预订 ￥1499</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-5 room-thumbnail-absolute">
                <a href="#" class="media d-block room bg first-room" style="background-image: url(images/r11.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                  <span>
                    风格套房
                ...
                <a href="#" class="media d-block room bg second-room" style="background-image: url(images/r07.jpg); ">
                    <!-- <figure> -->
                    <div class="overlap-text">
                  <span>
                    豪华单间
