            ...
            <div class="collapse navbar-collapse navbar-light" id="navbarsExample05">
                <ul class="navbar-nav ml-auto pl-lg-5 pl-0">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="resIndex.jsp">订餐</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="col-md-7">
                <div class="media d-block room mb-0">
                  ...
                  <span>
                    ...
                    <span class="ion-ios-star"></span>
                    <span class="ion-ios-star"></span>
                    <a class="nav-link" href="booknow.jsp"><span>现在预订</span></a>
                  </span>
                        </div>
                    </figure>
                    <div class="media-body">
                        ...
                        <p><a href="booknow.jsp" class="btn btn-primary btn-sm">现在预订 ￥1499</a></p>
                    </div>
                </div>
            </div>
